  ...
  <div class="container text-center">
    <div class="row">
      <div class="col-lg-10 mx-auto">
        ...
        <!--<h3>People</h3>
        <p>Don Scnultz (wanted to remain anonymous) - Overmind</p>
        <p>Ted Han - Undermind</p>
        <p>Kate Darling - The Popular One</p>
        <p>Carolyn Rupar-Han - Keeper of Lore</p>
...
<section class="content-section bg-primary text-white">
  <div class="container text-center">
    ...
    <p>Allison McCartney</p>
    <p>Anthony Buchanan</p>
    <p>Baron Oldenburg</p>
    <p>Ben Luxenberg</p>
    <p>Carolyn Rupar</p>
    <p>Christopher Anderson</p>
    <p>Chris Zubak-Skees</p>
    <p>Dan Schultz</p>
    <p>Erek Alper</p>
    <p>Ian Anderson</p>
    <p>Jason Miller&#42;</p>
