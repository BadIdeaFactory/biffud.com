  ...
  <div class="container text-center">
    <div class="row">
      <div class="col-lg-10 mx-auto">
        <h2>Working on the projects that nobody else wants to!</h2>
        <p class="lead mb-5">Sometimes, no matter how bad an idea might seem, you just have to try it out to be sure.</p>
